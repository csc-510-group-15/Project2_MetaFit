...
mock_data = [
    {'calories': 350, 'protein': 30, 'carbs': 20, 'fat': 15, 'goal': 'Maintenance'},
    {'calories': 250, 'protein': 5, 'carbs': 45, 'fat': 5, 'goal': 'Weight Loss'},
    {'calories': 400, 'protein': 40, 'carbs': 0, 'fat': 25, 'goal': 'Muscle Gain'},
    {'calories': 500, 'protein': 15, 'carbs': 50, 'fat': 20, 'goal': 'Muscle Gain'},
    {'calories': 600, 'protein': 45, 'carbs': 10, 'fat': 30, 'goal': 'Maintenance'},
    {'calories': 150, 'protein': 10, 'carbs': 15, 'fat': 5, 'goal': 'Weight Loss'},
    {'calories': 300, 'protein': 25, 'carbs': 35, 'fat': 10, 'goal': 'Maintenance'},
    {'calories': 250, 'protein': 30, 'carbs': 10, 'fat': 15, 'goal': 'Weight Loss'},
    {'calories': 400, 'protein': 20, 'carbs': 60, 'fat': 10, 'goal': 'Muscle Gain'},
    {'calories': 350, 'protein': 8, 'carbs': 45, 'fat': 20, 'goal': 'Maintenance'},
    {'calories': 300, 'protein': 10, 'carbs': 50, 'fat': 5, 'goal': 'Weight Loss'},
    {'calories': 450, 'protein': 35, 'carbs': 55, 'fat': 15, 'goal': 'Muscle Gain'},
    {'calories': 200, 'protein': 10, 'carbs': 40, 'fat': 5, 'goal': 'Weight Loss'},
    {'calories': 400, 'protein': 15, 'carbs': 30, 'fat': 20, 'goal': 'Muscle Gain'},
    {'calories': 600, 'protein': 50, 'carbs': 40, 'fat': 30, 'goal': 'Maintenance'},
    {'calories': 500, 'protein': 30, 'carbs': 50, 'fat': 20, 'goal': 'Muscle Gain'},
    {'calories': 150, 'protein': 15, 'carbs': 30, 'fat': 2, 'goal': 'Weight Loss'},
    {'calories': 200, 'protein': 20, 'carbs': 20, 'fat': 10, 'goal': 'Weight Loss'},
    {'calories': 400, 'protein': 30, 'carbs': 40, 'fat': 10, 'goal': 'Maintenance'},
    {'calories': 600, 'protein': 50, 'carbs': 50, 'fat': 25, 'goal': 'Muscle Gain'},
]

@pytest.fixture(scope="module")
def setup_model():
    """Fixture to setup the KNN model with mock data."""
    with patch('model.meal_recommendation.pd.read_csv', return_value=pd.DataFrame(mock_data)):
        model = train_model()
    return model
...
def test_valid_carbs_for_weight_loss(setup_model):
    ...
    result = recommend_meal_plan("Weight Loss", 300, 20, 40, 10)
    assert any(meal['goal'] == "Weight Loss" for meal in result)  # Expecting valid results
...
def test_minimum_protein_for_muscle_gain(setup_model):
    ...
    assert any(meal['goal'] == "Muscle Gain" for meal in result)  # Expecting valid results
