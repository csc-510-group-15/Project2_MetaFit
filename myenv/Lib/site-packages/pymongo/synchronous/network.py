...
def command(
    ...
    compression_ctx: Union[SnappyContext,
    ...
    if client and client._encrypter and reply:
        ...
        response_doc = cast(
            "_DocumentOut", _decode_all_selective(
                decrypted, codec_options, user_fields)[0]
        )
...
def receive_message(
    ...
    if op_code == 2012:
        ...
        data = decompress(_receive_data_on_socket(
            conn, length - 25, deadline), compressor_id)
    else:
