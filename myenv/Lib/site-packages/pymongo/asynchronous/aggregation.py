...
class _AggregationCommand:
    ...
    def __init__(
        ...
        result_processor: Optional[Callable[[
            Mapping[str, Any], AsyncConnection], None]] = None,
        comment: Any = None,
    ) -> None:
    ...
    def get_read_preference(
        ...
        if self._performs_write and pref != ReadPreference.PRIMARY:
            self._write_preference = pref = _AggWritePref(
                pref)  # type: ignore[assignment]
        return pref
    ...
    async def get_cursor(
        ...
        # Serialize command.
        cmd = {"aggregate": self._aggregation_target,
