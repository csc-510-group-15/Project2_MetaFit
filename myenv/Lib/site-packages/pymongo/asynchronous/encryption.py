...
_HTTPS_PORT = 443
# CDRIVER-3262 redefined this value to CONNECT_TIMEOUT
_KMS_CONNECT_TIMEOUT = CONNECT_TIMEOUT
...
class _EncryptionIO(AsyncMongoCryptCallback):  # type: ignore[misc]
    ...
    async def kms_request(self, kms_context: MongoCryptKmsContext) -> None:
        ...
        connect_timeout = max(_csot.clamp_remaining(
            _KMS_CONNECT_TIMEOUT), 0.001)
        opts = PoolOptions(
