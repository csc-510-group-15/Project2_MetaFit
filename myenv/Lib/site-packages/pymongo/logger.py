...
class LogMessage:
    ...
    def _is_sensitive(self, doc_name: str) -> bool:
        ...
        is_sensitive_hello = (
            self._kwargs.get(
                "commandName", None) in _HELLO_COMMANDS and is_speculative_authenticate
        )
    ...
    def _redact(self) -> None:
        ...
        if "durationMS" in self._kwargs and hasattr(self._kwargs["durationMS"], "total_seconds"):
            self._kwargs["durationMS"] = self._kwargs["durationMS"].total_seconds(
            ) * 1000
        ...
        for doc_name in _DOCUMENT_NAMES:
            ...
            if doc:
                ...
                if doc_name != "failure" and self._is_sensitive(doc_name):
                    ...
                    truncated_doc = _truncate_documents(
                        doc, document_length)[0]
                    doc = json_util.dumps(
                        truncated_doc,
