...
class URL:
    ...
    __slots__ = ("_cache", "_scheme", "_netloc",
        ...
        *,
        ...
        if encoded:
            ...
            if authority:
                ...
                _host = _encode_host(
                    _host, validate_host=False) if _host else ""
            elif host:
            ...
            query_string = QUERY_QUOTER(
                query_string) if query_string else query_string
    ...
    def _make_child(self, paths: "Sequence[str]", encoded: bool = False) -> "URL":
        ...
        if netloc := self._netloc:
            ...
            parsed = normalize_path_segments(
                parsed) if needs_normalize else parsed
    ...
    def with_suffix(self, suffix: str) -> "URL":
        ...
        name = name + \
            suffix if not old_suffix else name[: -len(old_suffix)] + suffix
