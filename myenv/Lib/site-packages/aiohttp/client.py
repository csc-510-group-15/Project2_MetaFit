...
class _RequestOptions(TypedDict, total=False):
    ...
    expect100: bool
    raise_for_status: Union[None, bool,
                            Callable[[ClientResponse], Awaitable[None]]]
    read_until_eof: bool
                ...
                while True:
                    ...
                    if resp.status in (301, 302, 303, 307, 308) and allow_redirects:
                        ...
                        if (resp.status == 303 and resp.method != hdrs.METH_HEAD) or (
                            resp.status in (
                                301, 302) and resp.method == hdrs.METH_POST
                        ):
    ...
    async def _ws_connect(
        ...
        *,
        ...
        try:
            ...
            match = base64.b64encode(hashlib.sha1(
                sec_key + WS_KEY).digest()).decode()
            if r_key != match:
                raise WSServerHandshakeError(
                    resp.request_info,
                    resp.history,
