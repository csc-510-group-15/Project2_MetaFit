...
def _nested_resource_class_methods(
    ...
    def wrapper(cls):
        def nested_resource_url(cls, id, nested_id=None):
            url = "%s/%s/%s" % (cls.class_url(),
                                quote_plus(id), quote_plus(path))
        ...
        for operation in operations:
            if operation == "create":
                ...
                setattr(cls, create_method, classmethod(
                ...
                setattr(cls, retrieve_method, classmethod(
                ...
                setattr(cls, modify_method, classmethod(
                ...
                setattr(cls, delete_method, classmethod(
                ...
                list_method = "list_%s" % resource_plural
                setattr(cls, list_method, classmethod(
                    paginated_list_nested_resources))
