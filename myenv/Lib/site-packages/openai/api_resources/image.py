...
class Image(APIResource):
    ...
    def create(
        ...
        **params,
        ...
        api_type, api_version = cls._get_api_type_and_version(
            api_type, api_version)

        response, _, api_key = requestor.request(
            "post", cls._get_url("generations", azure_action="submit",
                                 api_type=api_type, api_version=api_version), params
        )
        ...
        if api_type in (util.ApiType.AZURE, util.ApiType.AZURE_AD):
            ...
            response, _, api_key = requestor._poll(
                ...
                until=lambda response: response.data['status'] in [
                    'succeeded'],
    ...
    def _prepare_create_variation(
        ...
        **params,
        ...
        url = cls._get_url("variations", azure_action=None,
    ...
    def _prepare_create_edit(
        ...
        **params,
        ...
        url = cls._get_url("edits", azure_action=None,
                           api_type=api_type, api_version=api_version)
