...
def validate_email_deliverability(domain: str, domain_i18n: str, timeout: Optional[int] = None, dns_resolver: Optional[dns.resolver.Resolver] = None) -> DeliverabilityInfo:
    ...
    try:
        try:
            ...
            mtas = sorted([(r.preference, str(r.exchange).rstrip('.'))
                          for r in response])
            ...
            try:
                ...
                try:
                    ...
                    # have been raised).
                    raise EmailUndeliverableError(
                        f"The domain name {domain_i18n} does not accept email.") from e
        ...
        # for the domain name.
        raise EmailUndeliverableError(
            f"The domain name {domain_i18n} does not exist.") from e
