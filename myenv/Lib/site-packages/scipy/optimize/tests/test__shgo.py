...
class TestShgoArguments:
    ...
    def test_2_2_sobol_iter(self):
        ...
        np.testing.assert_allclose(
            res.x, test2_1.expected_x, rtol=1e-5, atol=1e-5)
    ...
    def test_5_1_simplicial_argless(self):
        ...
        np.testing.assert_allclose(
            res.x, test1_1.expected_x, rtol=1e-5, atol=1e-5)
    ...
    def test_6_1_simplicial_max_iter(self):
        ...
        np.testing.assert_allclose(
            res.x, test3_1.expected_x, rtol=1e-5, atol=1e-5)
...
def test_vector_constraint():
    ...
    res = shgo(rosen, [(0, 10), (0, 10)],
               constraints=oldc, sampling_method='sobol')
