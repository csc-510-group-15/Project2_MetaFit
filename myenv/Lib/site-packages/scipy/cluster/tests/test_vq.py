...
class TestVq:
    ...
    def test_vq_large_nfeat(self, xp):
        ...
        xp_assert_equal(codes1, xp.asarray(
            codes0, dtype=xp.int64), check_dtype=False)
...
class TestKMean:
    ...
    def test_kmeans_large_thres(self, xp):
        ...
        xp_assert_close(res[1], xp.asarray(
            2.3999999999999999, dtype=xp.float64)[()])
    ...
    def test_kmeans_diff_convergence(self, xp):
        ...
        xp_assert_close(res[1], xp.asarray(
            1.0666666666666667, dtype=xp.float64)[()])
