...
class TestMonteCarloHypothesisTest:
    ...
    def test_batch(self, xp):
        ...
        kwds['rvs'] = self.get_rvs(
            stats.norm.rvs, np.random.default_rng(328423), xp=xp)
...
class TestPower:
    ...
    def test_vectorization(self):
        ...
        def test(x, alternative, axis=-1):
            ...
            popmeans_expanded = np.expand_dims(
                popmeans, tuple(range(1, x.ndim + 1)))
    ...
    def test_ttest_ind_null(self):
        ...
        significance = np.broadcast_to(
            significance[:, np.newaxis], res.power.shape)
