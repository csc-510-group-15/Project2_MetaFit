    ...
    def test_empty_arg(self, xp):
        ...
        if is_numpy(xp):
            ...
            with np.testing.suppress_warnings() as sup:
                ...
                sup.filter(
                    UserWarning, r"var\(\): degrees of freedom is <= 0.")
...
class TestWilcoxon:
    ...
    def test_symmetry_gh19872_gh20752(self, method):
        ...
        assert_allclose(max_statistic - res.statistic,
                        ref.statistic, rtol=1e-15)
...
class TestKstat:
    def test_moments_normal_distribution(self, xp):
        ...
        xp_assert_close(xp.asarray((m1, m2, m3)),
                        expected[:-1], atol=0.02, rtol=1e-2)
...
class TestCircFuncs:
    ...
    def test_circfuncs_close(self, test_func, numpy_func, xp):
        ...
        x = np.asarray([0.12675364631578953] * 10 +
                       [0.12675365920187928] * 100)
    ...
    def test_circfuncs_uint8(self, xp):
        ...
        xp_assert_close(stats.circvar(x, high=180),
                        xp.asarray(0.2339555554617))
