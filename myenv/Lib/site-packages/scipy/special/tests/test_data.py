...
BOOST_TESTS = [
        ...
        data(gammainc, 'igamma_small_data_ipp-igamma_small_data',
             (0, 1), 5, rtol=5e-15),
        ...
        data(gdtr_, 'igamma_small_data_ipp-igamma_small_data',
             (0, 1), 5, rtol=1e-13),
        ...
        data(gdtrc_, 'igamma_small_data_ipp-igamma_small_data',
             (0, 1), 3, rtol=1e-13),
        ...
        data(gdtrib_comp, 'igamma_inva_data_ipp-igamma_inva_data',
             (1, 0), 3, rtol=5e-9),
        ...
        data(jn, 'bessel_j_large_data_ipp-bessel_j_large_data',
             (0, 1), 2, rtol=6e-11),
        data(jn, 'bessel_j_large_data_ipp-bessel_j_large_data',
             (0, 1j), 2, rtol=6e-11),
        ...
        data(kvp, 'bessel_k_prime_int_data_ipp-bessel_k_prime_int_data',
             (0, 1j), 2, rtol=3e-14),
        data(kvp, 'bessel_k_prime_data_ipp-bessel_k_prime_data',
             (0, 1), 2, rtol=7e-14),
        data(kvp, 'bessel_k_prime_data_ipp-bessel_k_prime_data',
             (0, 1j), 2, rtol=7e-14),
