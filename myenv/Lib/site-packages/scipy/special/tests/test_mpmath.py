...
class TestSystematic:
    ...
    def test_betainc(self):
        assert_mpmath_equal(
            ...
            time_limited()(
                exception_to_nan(
                    lambda a, b, x: mpmath.betainc(
                        a, b, 0, x, regularized=True)
                )
            ),
            [Arg(), Arg(), Arg()],
        )
    ...
    def test_ellipeinc(self):
        assert_mpmath_equal(sc.ellipeinc, mpmath.ellipe,
    ...
    def test_ellipf(self):
        assert_mpmath_equal(sc.ellipkinc, mpmath.ellipf,
                            [Arg(-1e3, 1e3), Arg()])
    ...
    def test_erf_complex(self):
        assert_mpmath_equal(sc.erf, lambda z: mpmath.erf(z), [
                            ComplexArg()], n=200)
    ...
    def test_legenp(self):
        ...
        assert_mpmath_equal(
            lpnm, legenp, [IntArg(-100, 100), IntArg(-100, 100), Arg()])
