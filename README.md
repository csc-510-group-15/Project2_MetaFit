...
| Question 4.5 | Do you provide troubleshooting information that describes the symptoms and step-by-step solutions for problems and error messages? |  | ❌ | The documentation does not include clear troubleshooting steps and solutions for common issues. [README](https://github.com/csc-510-group-15/Project2_MetaFit) |
| Question 4.6 | If your software can be used as a library, package or service by other software, do you provide comprehensive API documentation? | ✅ |  | While MetaFit isn’t provided as a full API, our modular training model code is well-documented for import as a package. |
...
| Question 4.8 | Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your website or in your documentation? | ✅ |  | The repository documents a detailed release history with version numbers and key features for each release. |
| **Q5 - Support**                 |                                                                                                                                                                                                                                                                                                                               |     |    |          |
...
| Question 5.3 | Does your project have an e-mail address or forum that is solely for supporting users? | ✅ |  | A dedicated email address exists for the project: burnoutapp123@gmail.com. This is the same email that sends out 2fa codes in METAFIT. Personal emails are also listed in this README. [Contact](https://github.com/csc-510-group-15/Project2_MetaFit?tab=readme-ov-file#Contributors) |
| Question 5.4 | Are e-mails to your support e-mail address received by more than one person? |  | ❌ | No such infrastructure exists at present. |
...
| Question 11.1 | Do you provide publicly-available instructions for building your software from the source code? | ✅ |  | Detailed build instructions are provided in the README for easy setup. [README](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/README.md) |
| Question 11.2 | Can you build, or package, your software using an automated tool? | ✅ |  | Automated build tools are integrated and documented in our README. [README](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/README.md) |
| Question 11.3 | Do you provide publicly-available instructions for deploying your software? | ✅ |  | Comprehensive deployment instructions are available to guide users through setup. [Deployment Guide](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/README.md) |
...
|Docs: doco generated, format not ugly|Class and function comments adhere to a consistent styling as per our linters, but nothing is generated from them at present. See [Screenshot](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/point_docs_1.png).|1|
...
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z|See [Screenshot 1](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/example_docs_1.png) and [Screenshot 2](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/example_docs_2.png).|2|
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing|See [Blurb](#the-concept).|3|
...
|Issues are discussed before they are closed|Issues are actively discussed on our Discord channel before being resolved. See [Screenshot 1](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/issue_discussion_1.png), [Screenshot 2](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/issue_discussion_2.png), and [Screenshot 3](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/issue_discussion_3.png).|3|
|Chat channel: exists|Group DM exists for bulk work, while class server channel is for progress updates and TA questions. See also [Screenshot 1](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/issue_discussion_1.png), [Screenshot 2](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/issue_discussion_2.png), and [Screenshot 3](https://github.com/csc-510-group-15/Project2_MetaFit/blob/main/evidence/issue_discussion_3.png).|3|
...
|Evidence that the whole team is using the same tools: everyone can get to all tools and files|Many different files have changed throughout main. See [Repository Pulse](https://github.com/csc-510-group-15/Project2_MetaFit/pulse).|3|
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)|See Popular Content window of [Traffic Activity](https://github.com/csc-510-group-15/Project2_MetaFit/graphs/traffic).|2|
