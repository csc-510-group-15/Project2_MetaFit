...
def meal_guide():
    ...
    # Process cook_guide to generate a list of numbered steps.
    # We assume steps are delimited by numbers followed by a dot.
    steps = re.split(r'\s*(?=\d+\.)', cook_guide.strip())
