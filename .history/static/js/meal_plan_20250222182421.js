                ...
                <div class="card mb-3" style="flex: 0 0 18%; margin-bottom: 20px; text-align: center;">
                    <div class="card-body p-2">
                        ...
                        <a class="btn btn-primary btn-sm mt-2" 
                           href="/meal_guide?food_name=${encodeURIComponent(meal.food_name || '')}&calories=${meal.calories}&protein=${meal.protein}&carbs=${meal.carbs}&fat=${meal.fat}&cook_guide=${encodeURIComponent(meal.cook_guide)}" 
