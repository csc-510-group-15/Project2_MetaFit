 ...
 * Each card has two columns: the left for text details (including score) and the right for a fixed-size image and a guide button.
...
function displayMealPlan(meals) {
    ...
    if (meals && meals.length > 0) {
        meals.forEach((meal, index) => {
            // Use meal.image_url if available; otherwise, fallback to a placeholder.
            const image_url = meal.image_url ? meal.image_url : "https://via.placeholder.com/150";
            console.log("Meal image URL:", image_url);
            const mealHTML = `
                <div class="card mb-3">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">
                                    Meal ${index + 1}: ${meal.food_name || "No name available"} - Score: ${meal.score}
                                </h5>
                        ...
                        <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                            <img src="${image_url}" alt="${meal.food_name || 'Meal Image'}" style="width:150px !important; height:150px !important; object-fit:cover !important;">
