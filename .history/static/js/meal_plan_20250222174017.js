 ...
 * Each card has two columns: left for text details (including the score) and right for a fixed-size image and a guide button.
...
$(document).ready(function() {
    // Uncomment the line below if you want to auto-fetch a meal plan on page load.
