...
def process_guide_text(guide_text):
    ...
    # Use regex to extract steps that start with a number and a dot.
    # The pattern captures a group that starts with one or more digits followed by a dot,
    # then lazily matches any characters until it encounters another number+dot or the end of string.
...
def meal_guide():
    ...
    # Process the cook guide string into a list of steps based on "1.", "2.", etc.
